...
class TokenBucket(RateLimit):
    ...
    def allow_request(self):
        with self.lock:
            ...
            self.tokens = min(self.total_capacity, int(tokens_to_add+self.tokens))
...
#             return
#
#         self.prev_window_counter = \
#             self.current_window_counter if ((curr - self.curr_window).total_seconds() // 60) == 1 else 0
#         self.current_window_counter = 0
